      ...
      <section class="section">
        ...
        <div class="container">
          <form action="index.php" method="POST" class="column is-5 is-paddingless" ref="form" @submit.prevent="submitForm">
            ...
            <div class="field">
              <label class="label">Description <span class="has-text-grey-light has-text-weight-normal"></span></label>
              <div class="control">
                <textarea autocomplete="off" name="description" class="textarea" rows="4" cols="30">Настоящее имя: 
Возраст: 
Статус: 
Семья: </textarea>
              </div>
